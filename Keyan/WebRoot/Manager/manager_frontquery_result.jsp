...
<%@ page import="com.shuangyulin.po.Manager" %>
<%
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#managerListPanel" aria-controls="managerListPanel" role="tab" data-toggle="tab">项目管理员列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Manager/manager_frontAdd.jsp" style="display:none;">添加项目管理员</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>用户名</td><td>姓名</td><td>性别</td><td>联系电话</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<managerList.size();i++) {
					    	            		...
					    	            		Manager manager = managerList.get(i); //获取到项目管理员对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;项目管理员信息编辑</h4>
      </div>
