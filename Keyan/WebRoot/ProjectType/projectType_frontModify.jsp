		...
		<div class="row"> 
		  ...
		  <div class="form-group">
			  ...
			  <div class="form-group">
			  	...
			  	<span onclick="ajaxProjectTypeModify();" class="btn btn-primary bottom5 top5">修改</span>
			  </div>
		</form> 
...
$(function(){
        ...
        new WOW().init();
    projectTypeEdit("<%=request.getParameter("projectTypeId")%>");
 })
 </script> 
</body>
</html>
