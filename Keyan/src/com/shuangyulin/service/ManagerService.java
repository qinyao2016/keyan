...
import com.shuangyulin.mapper.ManagerMapper;
@Service
public class ManagerService {
    ...
    /*按照查询条件分页查询项目管理员记录*/
    public ArrayList<Manager> queryManager(String managerUserName,String name,String telephone,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Manager> queryManager(String managerUserName,String name,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!managerUserName.equals("")) where = where + " and t_manager.managerUserName like '%" + managerUserName + "%'";
    	if(!name.equals("")) where = where + " and t_manager.name like '%" + name + "%'";
    	if(!telephone.equals("")) where = where + " and t_manager.telephone like '%" + telephone + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String managerUserName,String name,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!managerUserName.equals("")) where = where + " and t_manager.managerUserName like '%" + managerUserName + "%'";
    	if(!name.equals("")) where = where + " and t_manager.name like '%" + name + "%'";
    	if(!telephone.equals("")) where = where + " and t_manager.telephone like '%" + telephone + "%'";
